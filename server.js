...
app.get("/api/dashboard-data", (req, res) => {
    ...
    const dateForLast10Days = Array.from(
        { length: 10 },
        (_, i) =>
            moment()
                .subtract(9 - i, "days")
    ...
    const dateForLast7Days = Array.from(
        { length: 7 },
        (_, i) =>
            moment()
                .subtract(6 - i, "days")
    ...
    const dummyData = {
        ...
        topFailingTests: [
            ...
            {
                testName: "Environment Inconsistencies",
                failures: 20,
                total: 102,
            },
        ],
...
app.get("/api/recent-activity", (req, res) => {
    const recentActivities = [
        {
            id: 1089,
            name: "Load Account Balance Information",
            executedBy: "Jerome",
            date: "2023-11-07",
            result: "Passed",
        },
        {
            id: 1088,
            name: "Display Alerts for Unusaual Activity",
            executedBy: "Mathryn",
            date: "2023-11-06",
            result: "Failed",
        },
